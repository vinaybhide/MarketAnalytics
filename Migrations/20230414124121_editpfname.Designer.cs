...
namespace MarketAnalytics.Migrations
{
    ...
    [Migration("20230414124121_editpfname")]
    partial class editpfname
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketAnalytics.Models.BULLISH_ENGULFING_STRATEGY", b =>
                {
                    ...
                    b.ToTable("BULLISH_ENGULFING_STRATEGY");
                });
            ...
            modelBuilder.Entity("MarketAnalytics.Models.PORTFOLIOTXN", b =>
                {
                    ...
                    b.Property<double>("PURCHASE_QUANTITY")
                        .HasColumnType("REAL");
                    ...
                    b.Property<double>("SELL_QUANTITY")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("MarketAnalytics.Models.BEARISH_ENGULFING", b =>
                {
                    b.HasOne("MarketAnalytics.Models.StockMaster", "StockMaster")
                        .WithMany("collectionBearishEngulfing")
            ...
            modelBuilder.Entity("MarketAnalytics.Models.BULLISH_ENGULFING_STRATEGY", b =>
                {
                    b.HasOne("MarketAnalytics.Models.StockMaster", "StockMaster")
                        .WithMany("collectionBullishEngulfing")
                        .HasForeignKey("StockMasterID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MarketAnalytics.Models.StockPriceHistory", b =>
                {
                    b.HasOne("MarketAnalytics.Models.StockMaster", "StockMaster")
                        .WithMany("collectionStockPriceHistory")
                        .HasForeignKey("StockMasterID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MarketAnalytics.Models.StockMaster", b =>
                {
                    b.Navigation("collectionBearishEngulfing");

                    b.Navigation("collectionBullishEngulfing");

                    b.Navigation("collectionStockPriceHistory");
